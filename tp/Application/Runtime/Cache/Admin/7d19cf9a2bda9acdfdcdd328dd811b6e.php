...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php/Admin/Arruser/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">文章管理</span></div>
        </div>
            ...
            action="#">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/index.php/Admin/Arruser/add"><i class="icon-font"></i>新增文章</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($row)): $i = 0; $__LIST__ = $row;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ao): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if($ao > 60): ?><p style="color: green;">用户正常</p>
                                    <?php else: ?>
                                    <p style="color: red;">用户被封杀</p><?php endif; ?>
                            ...
                            <td>
                                <a class="link-update" href="/index.php/Admin/Arruser/lock/id/<?php echo ($ao["id"]); ?>" onclick="return confirm('是否封杀?');">封杀</a>
