...
<head>
    <meta charset="UTF-8">
    <title>『豪情』后台管理</title>
    <link href="http://localhost/tp//Application/Admin/Public/css/admin_login.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class="admin_login_wrap">
    ...
    <div class="adming_login_border">
        <div class="admin_input">
            <form action="<?php echo U('Admin/login_to');?>" method="post">
