    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Essay/up');?>" method="post" id="myform" name="myform">
                        ...
                        <tbody>
                            ...
                            <td>
                                <select name="cateid" id="cateid" class="required">
                                    ...
                                    <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bo): $mod = ($i % 2 );++$i;?><option 
                                    <?php if($bo['id'] == $art['cateid']): ?>selected = "selected"<?php endif; ?>value="<?php echo ($bo["id"]); ?>"><?php echo ($bo["list"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                        </tr>
                            <tr>
