    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Link/up');?>" method="post" id="myform" name="myform">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="link" name="link" size="50" value="<?php echo ($art["link"]); ?>" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>链接地址：</th>
                                <td>
                                    <input class="common-text required" id="url" name="url" size="50" value="<?php echo ($art["url"]); ?>" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>内容：</th>
                                <td>
                                    <input class="common-text required" id="desca" name="desca" size="50" value="<?php echo ($art["desca"]); ?>" type="text">
                                </td>
                            </tr>
                           <!-- <tr>
                                <th>作者：</th>
