...
<head>
	...
	<!-- Style --> 
	<link rel="stylesheet" href="http://localhost/tp//Application/Home/Public//css/style.css" type="text/css" media="all">
	...
	<div class="container w3layouts agileits">
		...
		<div class="login w3layouts agileits">
			...
			<form action="<?php echo U('Home/Login_do');?>" method="post">
				...
				<img src="<?php echo U('Home/Verify');?>" style="width:50%;" title="点击更换验证码" onclick="this.src='<?php echo U('Home/Verify');?>?'+Math.random(0,99999)">
			...
			<div class="send-button w3layouts agileits">
					...
					<input type="submit" value="登 录" name="num">
				</form>
			</div>
			<a href="#">记住密码?</a>
		...
		<div class="register w3layouts agileits">
			<h2>注 册</h2>
			<form action="<?php echo U('Home/login');?>" method="post">
			...
			<form action="<?php echo U('Home/Regice_do');?>" method="post">
				...
				<input type="password" Name="password" id='Paassword' placeholder="密码" required="" onblur="s_pwd()"><span id='ss_pwd'></span>
				<input type="password" Name="pwd" id='Password' placeholder="确认密码" required="" onblur="s_pwd()"><span id='ss_pwd'></span>
